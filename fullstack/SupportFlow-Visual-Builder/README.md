...
On the canvas, Start and Question nodes include a small `+` connector handle. Drag it onto another node to create a new route visually, then rename or retarget that route in the Routes tab if needed.
